...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (phone) {
      // Pakistan phone format: +92 followed by 10 digits, or 0 followed by 10 digits
        ...
        {currentStep === 1 ? (
          <form className="mt-8 space-y-6" onSubmit={handleContinue}>
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  ...
                  uppercase letter, a number, and one of these special
                  characters: !@#$%^&*()
                </p>
              </div>
            ...
            <div className="flex justify-between">
              <button
                type="submit"
                className="w-full py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-md transition-all duration-200"
              >
                Continue
              </button>
            </div>
